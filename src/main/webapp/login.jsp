...
<c:if test="${param.error != null}">
	<center>
	<div class="error">
		<img src="${ctx}/<%=request.getContextPath()%>/images/iconWarning.gif"
				...
				<table width="380" border="0" align="center" cellPadding="0"
					...
					<tr>
						...
						<td width="171" height="24" rowSpan="2"
							background="<%=request.getContextPath()%>/images/fdo_tit_centro.gif" class="tituloCabecera">
						ACCESO</td>
				...
				<table cellSpacing="0" cellPadding="0" width="380" align="center"
					...
					<tr>
						...
						<td vAlign="top" width="80%" style="border-left:1px;"
							background="<%=request.getContextPath()%>/images/t3-abajo.gif"></td>
						<td vAlign="top" width="26" height="1"><IMG height="26"
							src="<%=request.getContextPath()%>/images/fdo_tabla_ico_izq.gif" width="40"></td>
						<td colspan="2" align="left" vAlign="bottom" height="1"
							background="<%=request.getContextPath()%>/images/t3-arribaGrande.gif">
						<table cellpadding="0" cellspacing="0" border="0" align="center">
							<tr>
								<td rowspan="3" width="5" height="13"><img
									src="<%=request.getContextPath()%>/images/izda.gif" width="12" height="20" border="0" alt=""></td>
								<td height="1" width="70"><img src="<%=request.getContextPath()%>/images/spacerAzul.gif"
							...
							<tr>
								<td width="70" valign="bottom"><img
									src="<%=request.getContextPath()%>/images/spacerAzul.gif" width="70" height="2" border="0"
									alt=""></td>
							</tr>
						</table>
						</td>
