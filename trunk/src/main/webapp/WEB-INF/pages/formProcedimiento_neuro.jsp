...
<form:form commandName="procedimiento" name="formProcedimiento"
	...
	<table border="0" width="100%" class="laterales" cellpadding="5">
		...
		<tr>
			<td style=""><span>Referencia del Neuroform:</span></td>
			<td><form:select path="neuroformStentSelect" multiple="true"
				cssClass="desplegable" size="6">
				<form:options items="${neuroformStent}" itemValue="value"
					itemLabel="label" />
			</form:select></td>
			<td></td>
			<td></td>
