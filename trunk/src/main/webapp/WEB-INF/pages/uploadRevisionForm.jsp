		...
		<tr class="tituloTabla2">
			...
			<td widht="100%" bgcolor="#FFFFFF">
				<table cellpadding="10" width="100%">
					<tr class="tituloTabla2">
						<td width="40%" align="center" valign="middle"><img src="/viewRevisionImagen.html?id=${imagen.id}" border="1"
							style="border-color: #466492;" /></td>
						<td valign="top">${imagen.descripcion}</td>
						<td valign="top" width="10%">${imagen.fase}</td>
					</tr>
				</table>
			</td>
			<td width="1" bgcolor="#466492"></td>
...
<form:form commandName="fileUpload" method="post"
	action="fileRevisionUpload.html" enctype="multipart/form-data"
					...
					<table width="100%" border="0" cellspacing="0" cellpadding="0">
						<tr>
							...
							<table width="100%" border="0" align="center" cellpadding="2"
								cellspacing="0">
								<tr>
									<td width="14%" align="right" class="etiqueta">Revision</td>
									<td> <form:select path="fase" cssClass="desplegable">
										<form:option value="6 meses" />
										<form:option value="1 año" />
										<form:option value="2 años" />
										</form:select>
									</td>
								</tr>
							</table>
