...
*/
    ...
    */
    ...
    Calendario.prototype.show = function() 
    {
        ...
        */
	    this.wwrite("<html>");
	    this.wwrite("<head><title>Seleccione fecha, por favor.</title>");
	    this.wwrite("</head>");
		...
		"'" + this.gReturnp_item + "', '" + this.dameNumeroMes + "', '" + (parseInt(this.gYear)+1) + "', '" + this.gFormat + "'" +
		");" +
		"\"><img src='images/anoMas.gif' border=0><\/A></TD></TR><tr><td height=2></td></tr></TABLE>");
    ...
    */
    Calendario.prototype.showY = function() 
    {
    	...
    	this.wwrite("<TABLE WIDTH='100%' border=0 CELLSPACING=0 CELLPADDING=0><tr><td height=2></td></tr><TR><TD ALIGN=center>");
    	this.wwrite("[<A HREF=\"" +
		"javascript:window.opener.Build(" + 
    	...
    	for (i=11; i>=0; i--) 
        {
    		...
    		vCode = this.getMonthlyCalendarioCode();
    		this.wwrite(this.dameMes + "/" + this.gYear);
    		this.wwrite(vCode);
    		if (isIE)
     			this.wwrite("</DIV>");
    		else if (isNav)
    ...
    */
    Calendario.prototype.cal_header = function() 
    {
    	...
    	vCode = vCode + "<TD WIDTH='16%'><FONT SIZE='2' FACE='" + familia_fuente + "' COLOR='#0D355B'><B>&nbsp;S&nbsp;</B></FONT></TD>";
        vCode = vCode + "<TD WIDTH='14%'><FONT SIZE='2' FACE='" + familia_fuente + "' COLOR='#0D355B'><B>&nbsp;D&nbsp;</B></FONT></TD>";
       vCode = vCode + "</TR>";	
    	return vCode;
    }
    	...
    	for (k=2; k<7; k++) 
        {
	     ...
	     for (m=1; m<(7-j); m++) 
         {
		     if (this.dameAnyo)
			     ...
			     "><FONT SIZE='2' FACE='" + familia_fuente + "' COLOR='white' style='text-decoration=none'> </FONT></TD>";
		    else
			    vCode = vCode + "<TD WIDTH='14%'" + this.write_festivos_string(j+m) + 
			    "><FONT SIZE='2' FACE='" + familia_fuente + "' COLOR='white' style='text-decoration=none'>" + m + "</FONT></TD>";
	     }	
	     return vCode;
     }
   ...
   * funcion que muestra el calendario en la ventana flotante
    */
    function show_Calendario() 
    {
        ...
        */
        vWinCal = window.open("", "Calendario", "width=240,height=180,status=no,resizable=no,top=200,left=200");
	    vWinCal.opener = self;
	    calculo = vWinCal;
...
*/
    ...
    */
    Calendario.prototype.showY = function() 
    {
	    ...
	    var prevYYYY = parseInt(this.gYear) - 1;
    	var nextYYYY = parseInt(this.gYear) + 1;	
    	this.wwrite("<TABLE WIDTH='100%' BORDER=0 CELLSPACING=0 CELLPADDING=0 BGCOLOR='#ffcc66'><tr><td height=2></td></tr><TR><TD ALIGN=center>");
    	this.wwrite("<A HREF=\"" +
		"javascript:window.opener.Build(" + 
		"'" + this.gReturnp_item + "', null, '" + prevYYYY + "', '" + this.gFormat + "'" +
		");" +
...
*/
    ...
    */
    Calendario.prototype.getMonthlyCalendarioCode = function() 
    {
	   ...
	   /**
       *  dibujamos la tabla del calendario en la ventana flotante, Se rellena con filas que definimos luego
	   		TABLA QUE TIENE SOLO EL CALENDARIO
       */
	   // @@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
	    vCode = vCode + "<TABLE BORDER=1 bordercolor='#177EB0' cellspacing='2' cellpadding='0' BGCOLOR=\"" + this.gBGColor + "\">";	
	    vHeader_Code = this.cal_header();
	    vData_Code = this.cal_data();
	    vCode = vCode + vHeader_Code + vData_Code;	
	    vCode = vCode + "</TABLE>";	
    ...
    */
    Calendario.prototype.cal_header = function() 
    {
	    var vCode = "";	
       	vCode = vCode + "<TR>";
    	vCode = vCode + "<TD WIDTH='14%'><FONT SIZE='2' FACE='" + familia_fuente + "' COLOR='#0D355B'><B>&nbsp;Lu&nbsp;</B></FONT></TD>";
    	vCode = vCode + "<TD WIDTH='14%'><FONT SIZE='2' FACE='" + familia_fuente + "' COLOR='#0D355B'><B>&nbsp;Ma&nbsp;</B></FONT></TD>";
    	vCode = vCode + "<TD WIDTH='14%'><FONT SIZE='2' FACE='" + familia_fuente + "' COLOR='#0D355B'><B>&nbsp;Mi&nbsp;</B></FONT></TD>";
    	vCode = vCode + "<TD WIDTH='14%'><FONT SIZE='2' FACE='" + familia_fuente + "' COLOR='#0D355B'><B>&nbsp;Ju&nbsp;</B></FONT></TD>";
    	vCode = vCode + "<TD WIDTH='14%'><FONT SIZE='2' FACE='" + familia_fuente + "' COLOR='#0D355B'><B>&nbsp;Vi&nbsp;</B></FONT></TD>";
    	vCode = vCode + "<TD WIDTH='16%'><FONT SIZE='2' FACE='" + familia_fuente + "' COLOR='#0D355B'><B>&nbsp;Sa&nbsp;</B></FONT></TD>";
        vCode = vCode + "<TD WIDTH='14%'><FONT SIZE='2' FACE='" + familia_fuente + "' COLOR='#0D355B'><B>&nbsp;Do&nbsp;</B></FONT></TD>";
       vCode = vCode + "</TR>";	
    	return vCode;
    }
    ...
    */
    Calendario.prototype.format_day = function(vday) 
    {
    	...
    	var vNowYear = ahora.getFullYear();
    	if (vday == vNowDay && this.dameNumeroMes == vNowMonth && this.gYear == vNowYear)
	    	return ("<FONT COLOR=\"#000000\"  style='text-decoration=none'><B>" + vday + "</B></FONT>");
    	else
    		return (vday);
    }
